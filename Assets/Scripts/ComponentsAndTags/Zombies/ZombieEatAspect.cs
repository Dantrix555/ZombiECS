...
public readonly partial struct ZombieEatAspect : IAspect
{
    ...
    public void Eat(float deltaTime, EntityCommandBuffer.ParallelWriter commandBuffer, int sortKey, Entity brainEntity)
    {
        ...
        commandBuffer.AppendToBuffer(sortKey, brainEntity, curBrainDamage);
    }
